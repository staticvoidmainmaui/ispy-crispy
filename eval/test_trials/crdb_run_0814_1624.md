...
DISTANCE_THRESHOLD = 0.6 was against miniLM . Needs retuning but retreival case is a baseline , doesnt need perfection. 
...
| Embeddings | `bedrock-titan-text-embedder-v2`, 384-dim, mean pooling, normalized |
